...
return [
    ...
    'alerts' => [
        ...
        'transfer_not_viable' => 'TLe nœud que vous avez sélectionné ne dispose pas de l\'espace disque requis ou de la mémoire disponible pour accueillir ce serveur.',
    ],
];
